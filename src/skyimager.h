 ...
 */
//#define SKYIMAGER_TEST

#define APPLICATION_NAME            "SkyImager"
#if defined(_M_AMD64)
...
#define MAX_ISO_TO_ESP_SIZE         (1 * GB)	// Maximum size we allow for the ISO â†’ ESP option
...
#define SKYIMAGER_URL                   "http://nas/~skyimager"
#else
#define SKYIMAGER_URL                   "https://skyious.github.io/SkyImager"
#endif
#define DOWNLOAD_URL                SKYIMAGER_URL "/downloads"
#define FILES_URL                   SKYIMAGER_URL "/files"
#define FILES_DIR                   APPLICATION_NAME
#define FIDO_VERSION                "z1"
#define WPPRECORDER_MORE_INFO_URL   "https://github.com/SKYIOUS/SkyImager/wiki/FAQ#bsods-with-windows-to-go-drives-created-from-windows-10-1809-isos"
 ...
 * Globals
 */
extern SKYIMAGER_UPDATE update;
extern SKYIMAGER_IMG_REPORT img_report;
...
extern uint16_t skyimager_version[3], embedded_sl_version[2];
...
#define SKYIMAGER_ERROR(err)               (ERROR_SEVERITY_ERROR | FAC(FACILITY_STORAGE) | (err))
