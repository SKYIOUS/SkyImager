SkyImager: The Reliable USB Formatting Utility - Windows 11 Setup wrapper
...
Basically, per https://github.com/pbatard/skyimager/issues/2568#issuecomment-2387934171,
and if the user chose to apply the hardware requirement bypasses in SkyImager, you want
...
Our solution then is to have SkyImager rename the original 'setup.exe' to 'setup.dll'
...
make sure that the one we sign and embed in SkyImager does get built using GitHub Actions
...
https://github.com/pbatard/skyimager/blob/master/.github/workflows/setup.yml).

Per the https://github.com/pbatard/skyimager/actions/runs/16191913388 GitHub Actions
